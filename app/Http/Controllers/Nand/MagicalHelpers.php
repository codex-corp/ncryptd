<?php namespace App\Http\Controllers\Nand;
...
class MagicalHelpers extends MagicalController
{
    ...
    public static function CompressProject(){
        ...
        \Zipper::make(TARGET_DIR.'/project.zip')->add( glob(TARGET_DIR . '/*') );
    }
...
//        \Zipper::make($file)->folder('test')->extractTo('foo');
